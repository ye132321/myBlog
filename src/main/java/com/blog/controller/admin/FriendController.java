...
public class FriendController {
    ...
    public String addFriendlinks(FriendLink friendLink, BindingResult result, RedirectAttributes attributes){
    ...
    public String editFriendlink(FriendLink friendLink,RedirectAttributes attributes){
